            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Import Bfat</li>
                    </ol>
                </section>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="box">
                                ...
                                <form action="<?php echo base_url(); ?>index.php/rate/import_bfat" class="form-horizontal" method="post" id="import_bfat" enctype="multipart/form-data">
